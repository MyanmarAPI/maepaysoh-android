...
public abstract class CandidateAPIProperties<T> {
  ...
  public static final CandidateAPIProperties<Integer> PER_PAGE = new CandidateAPIProperties<Integer>(Integer.class) {};
  public static final CandidateAPIProperties<Boolean> CACHE = new CandidateAPIProperties<Boolean>(Boolean.class){};
