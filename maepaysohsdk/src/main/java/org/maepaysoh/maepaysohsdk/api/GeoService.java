...
public interface GeoService {
  ...
  @GET("/geo/district") GeoReturnObject getLocationByRegion(@QueryMap  Map<PARAM_FIELD,String> options);

  @GET("/geo/district") GeoReturnObject getLocationByPcode(@QueryMap  Map<PARAM_FIELD,String> options);
